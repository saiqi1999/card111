...
# 卡牌生成位置相关常量（基于卡牌尺寸）
const CARD_SPAWN_MIN_DISTANCE: float = CARD_WIDTH * 1.5  # 默认生成最小距离（300）
const CARD_SPAWN_MAX_DISTANCE: float = CARD_WIDTH * 3.0  # 默认生成最大距离（600）
const CARD_SPAWN_MIN_DISTANCE_CLOSE: float = CARD_WIDTH * 1.5  # 近距离生成最小距离（300）
const CARD_SPAWN_MAX_DISTANCE_CLOSE: float = CARD_WIDTH * 2.5  # 近距离生成最大距离（500）
...
static func get_all_constants() -> Dictionary:
	return {
		...
		"CARD_SPAWN_MIN_DISTANCE": CARD_SPAWN_MIN_DISTANCE,
		"CARD_SPAWN_MAX_DISTANCE": CARD_SPAWN_MAX_DISTANCE,
		"CARD_SPAWN_MIN_DISTANCE_CLOSE": CARD_SPAWN_MIN_DISTANCE_CLOSE,
		"CARD_SPAWN_MAX_DISTANCE_CLOSE": CARD_SPAWN_MAX_DISTANCE_CLOSE,
		"CARD_SPAWN_MIN_DISTANCE_FAR": CARD_SPAWN_MIN_DISTANCE_FAR,
		"CARD_SPAWN_MAX_DISTANCE_FAR": CARD_SPAWN_MAX_DISTANCE_FAR,
